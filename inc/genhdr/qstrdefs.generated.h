...
QDEF(MP_QSTR_bitbot, (const byte*)"\x63\x06" "bitbot")
QDEF(MP_QSTR_BitBot, (const byte*)"\x23\x06" "BitBot")
QDEF(MP_QSTR_set_rgb, (const byte*)"\xcf\x07" "set_rgb")
QDEF(MP_QSTR_get_rgb, (const byte*)"\xdb\x07" "get_rgb")
QDEF(MP_QSTR_set_speed, (const byte*)"\x9f\x09" "set_speed")
QDEF(MP_QSTR_buzz, (const byte*)"\x12\x04" "buzz")
QDEF(MP_QSTR_get_light, (const byte*)"\x12\x09" "get_light")
QDEF(MP_QSTR_is_line_left, (const byte*)"\x4a\x0c" "is_line_left")
QDEF(MP_QSTR_is_line_right, (const byte*)"\xf1\x0d" "is_line_right")
