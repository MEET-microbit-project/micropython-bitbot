...
// for an inexplicable reason, PIN_CAPABILITY_DIGITAL_OUT etc. are not
// defined even when MicroBitPin is included.
const PinCapability analog_in = (PinCapability)0x04;
const PinCapability analog_out = (PinCapability)0x08;
const PinCapability digital_out = (PinCapability)0x02;
const PinCapability digital_in = (PinCapability)0x01;
...
#endif /* end of include guard: PINS_HELPER */
